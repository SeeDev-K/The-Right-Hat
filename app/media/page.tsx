const articles = [
  ['Ransomware readiness', 'How leaders can prepare before the first encrypted server.'],
  ['Threat detection basics', 'Why useful detections start with behavior, not noise.'],
  ['Cyber career map', 'A practical roadmap for juniors entering cybersecurity.'],
]
